  ...
  const renderList = function (playlist) {
    ...
    while (node) {
      ...
      result.push(
        <ListGroup.Item
          as='div'
          key={'a' + currentNode.mixnum + '-' + count}
        ...
        >
          <div className='playlist-holder'>
            <div className='playlist-name'>&#x2630; {currentNode.name}</div>
            ...
            <div className='playlist-buttons'>
              <Button
                ...
                title='Play Now'
                alt='Play Now'
                onClick={() => dispatch(playLink(currentNode))}
                alt='play'
              >
                <RiPlayFill />
              </Button>
              <Button
                ...
                alt='Remove'
                onClick={() => {
                  dispatch(deleteTrack(currentNode));
                  dispatch(rerenderNow());
                }}
                alt='delete'
              >
      ...
      <div>
        <ListGroup.Item className='dark-list-item'>
          ...
          <div className='player-button-holder'>
            <Button
              className='player-button'
              onClick={() => dispatch(playLink(playlist.head))}
            >
              Play
            </Button>
            <Button
            ...
            <Button
              className='player-button'
              onClick={() => {
                dispatch(createPlaylist(entries));
                dispatch(rerenderNow());
              }}
            >
              Reset
