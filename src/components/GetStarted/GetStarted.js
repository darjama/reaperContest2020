          ...
          <Card style={{ minWidth: '30rem' }}>
            <Card.Body>
              ...
              <p>
                ...
                Workstation (DAW) that is cross platform (Windows, MacOS, Linux)
                and includes a great number of effects and can be extended in a
                number of ways.
              </p>
              <p>
                A useful Reaper extension is known as SWS. It expands reapers
                functionality in a number of ways, but one that is important for
                the contest is the ability to measure loudness using LUFS.
              </p>
            </Card.Body>
            <Card.Footer
            ...
            <Card.Body>
              ...
              <ol>
                ...
                <p>
                  ...
                  ) since this won't affect the output. Using (public domain)
                  3rd party impulse responses in ReaVerb is permitted, provided
                  you include them with your submitted files.
                </p>
                <li>
                  The loudness measurement of the project should not exceed -14
                  LUFS (integrated), and the peak should not exceed -1 dBFS.
                </li>
                <p>
            ...
            <Card.Body>
              ...
              <ol>
                ...
                <li>
                  ...
                  reverb impulses you've used, any customized or 3rd party JSFX
                  (Tukan plugins don't need to be included), and a FLAC of your
                  master mix.
                </li>
                <li>
                  <strong style={{ textDecoration: 'underline' }}>DON'T</strong>{' '}
                  include the original media files in your upload.
                </li>
                <li>Listen to the submissions.</li>
                <li>
                  Rate all the mixes (aside from your own) and leave mix notes.
                </li>
                <li>
                  See who won, and check out the other participants' projects.
                </li>
                <li>
                  The winner gets to help choose a project for the next month's
                  contest. And the glory. But that's about it.
                </li>
              </ol>
            </Card.Body>
          </Card>
